    ...
    async (payload, thunkAPI) => { 
        try {
            const data = await axios.get(
              `${API_URL}/post/application/${payload}`,
              {
                headers: {
...
export const __refuse = createAsyncThunk(
    ...
    async (payload, thunkAPI) => { 
        try {
            const data = await axios.post(`${API_URL}/post/application/disapprove/${payload}`, {applicationId: payload}, {
            headers: {
                authorization: localStorage.getItem("ACCESSTOKEN"),
                refreshtoken: localStorage.getItem("REFRESHTOKEN")
            }
...
export const __accept = createAsyncThunk(
    ...
    async (payload, thunkAPI) => { 
        try {
            const data = await axios.post(`${API_URL}/post/application/approve/${payload}`, {applicationId: payload}, {
            headers: {
                authorization: localStorage.getItem("ACCESSTOKEN"),
                refreshtoken: localStorage.getItem("REFRESHTOKEN")
            }
