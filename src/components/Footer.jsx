...
const Footer = () => {
    ...
    return (
        <FooterWrap>
            ...
            <LogoNCopyRight>
                <CopyRight>Copyright @2022 삼삼오오(3355).All rights reserved.</CopyRight>
                <InfoBtnWrap>
                      ...
                      <SnsWrap>
                          <Contact>
                            <a href="https://github.com/Eng-Fluencer">
                              <ContactGit title="Eng-Fluencer GitHub 바로가기"><BsGithub/></ContactGit></a>
                          </Contact>
                      </SnsWrap>
                  </InfoCateWrap>
                  <RoleCateWrap>
                      ...
                      <FEBEWrap>
                          <NameText>FE<br/>이혜림ㅤ  이경하ㅤ  김고은</NameText>
                      </FEBEWrap>
                      <FEBEWrap>
                          <NameText>BE<br/>김범석ㅤ  김하영</NameText>
                      </FEBEWrap>                    
                  </RoleCateWrap>
            </RoleWrap>
         </InfoWrap>
